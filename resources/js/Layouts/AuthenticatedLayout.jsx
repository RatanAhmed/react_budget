            ...
            <nav className="bg-white border-b border-gray-100">
                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
                    <div className="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink href={route('income.index')} active={route().current('income.index')}>
                            Earning
                        </ResponsiveNavLink>
                        <ResponsiveNavLink href={route('budget.index')} active={route().current('budget.index')}>
                            Budget
                        </ResponsiveNavLink>
