        ...
        <AuthenticatedLayout user={auth.user}>
            ...
            <table className="table-auto border-collapse " width="100%">
                ...
                <tbody>
                    ...
                    <tr>
                        <td className='text-center border border-slate-300'>{ earning.source }</td>
                        <td className='text-left border border-slate-300'>{ earning.details }</td>
                        <td className='text-center border border-slate-300'>{ earning.amount }</td>
                        <td className='text-center border border-slate-300'>{ earning.status == 1 ? "Active" : "Inactive" }</td>
                        <td className='text-center border border-slate-300'>{ earning.type == 1 ? "Salary" : "Partial" }</td>
                ...
                <form onSubmit={submit}>
                    <div>
                        <div className="text-xl font-semibold">Earning Details</div>
                    </div>
